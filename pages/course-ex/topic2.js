            ...
            <div className="px-[104px]">
                <div className="grid grid-cols-1 w-full shadow-[0px_4px_20px_0px_rgba(0,0,0,0.25)] rounded-[11px]">
                    ...
                    <div className="flex flex-row-2">
                        ...
                        <iframe width="800" height="450" src="https://www.youtube.com/embed/O-8kPCf9oGA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" className="mt-[20px] rounded-[11px]" allowfullscreen></iframe>
