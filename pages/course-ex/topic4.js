            ...
            <div className="px-[104px]">
                <div className="grid grid-cols-1 w-full shadow-[0px_4px_20px_0px_rgba(0,0,0,0.25)] rounded-[11px]">
                    ...
                    <div className="flex flex-row-2">
                            ...
                            <ol className="ml-[40px] mt-[32px]">
                                ...
                                <li class="border-l-2 border-[#FFCA61]">
                                    <div class="md:flex flex-start">
                                        ...
                                        <a href="#" className="w-[200px] h-[72px] text-black ml-[28px] text-[color:#FFA400]">บทที่ 4 การเขียนโปรแกรมแบบทางเลือก</a>
                                    </div>
                                </li>
                        ...
                        <iframe width="800" height="450" src="https://www.youtube.com/embed/6Mu6cil3_Iw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" className="mt-[20px] ml-[15px] rounded-[11px]" allowfullscreen></iframe>
