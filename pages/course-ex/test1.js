          ...
          <div className="grid grid-cols-1 w-full shadow-[0px_4px_20px_0px_rgba(0,0,0,0.25)] rounded-[11px]">
            ...
            <div className="flex flex-row-2">
                ...
                <ol className="ml-[40px] mt-[32px]">
                  ...
                  <li class="border-l-2 border-white">
                    <div class="md:flex flex-start">
                      ...
                      <a
                        href="#"
                        className="w-[200px] h-[48px] text-[#FFCA61] ml-[12px]"
                      >
                        แบบทดสอบหลังเรียน
                      </a>
                    </div>
              ...
              <div className="flex flex-col mx-auto">
                <div className="font-semibold text-[22px] mt-[32px] mx-auto">
                  แบบทดสอบหลังเรียน
                </div>
                <hr class="class-1" />
                <div className="font-semibold text-[20px] mt-[48px] underline ml-[42px]">
                  คำชี้แจง
                </div>
                <div className="text-[18px] mt-[36px] mx-[42px]">
                  แบบทดสอบชุดนี้จัดทำขึ้น
                  โดยมีวัตถุประสงค์เพื่อประเมินความรู้ความเข้าใจในการเรียนผ่านระบบ
                  ComPort กรณีที่ต้องการขอรับวุฒิบัตร ท่านต้องสอบผ่านไม่น้อยกว่า
                ...
                <hr class="class-2" />
                <a
                  href="/course-ex/test2"
                  className="text-[16px] mt-[20px] drop-shadow-[0px_4px_0px_rgba(0,0,0,0.25)] text-center w-[155px] h-[52px] py-[13px] bg-[#FFCA61] rounded-[8px] mx-auto"
                >
                  เริ่มแบบทดสอบ
                </a>
              </div>
