        ...
        <div className="grid grid-cols-1 w-full shadow-[0px_4px_20px_0px_rgba(0,0,0,0.25)] rounded-[11px]">
          ...
          <div className="flex flex-row-2">
              ...
              <ol className="ml-[40px] mt-[32px]">
                <li className="border-l-2 border-[#FFCA61]">
                  <div className="md:flex flex-start">
                    ...
                    <a
                      href="#"
                      className="w-[339px] h-[48px] text-[#FFCA61] ml-[12px] cursor-pointer"
                    >
                      ดาวน์โหลดเอกสาร
                    </a>
                  </div>
            ...
            <div className="flex flex-col mx-auto">
              <div className="text-[14px] text-black mt-[24px]">
                ดาวน์โหลดเอกสารประกอบการเรียนทั้งหมดของหลักสูตรนี้
              </div>
              <div className="mt-[14px] w-full h-[145px] bg-white rounded-[11px] drop-shadow-[0px_4px_12px_rgba(0,0,0,0.25)]">
                <div className="flex flex-row">
                  ...
                  <div className="flex flex-col">
                    <div className="text-[22px] font-semibold ml-[56px] mt-[42px]">
                      เอกสารประกอบการเรียน
                    </div>
                    <div className="text-[16px] ml-[56px] mt-[18px]">
                      3.16 MB
                    </div>
                  </div>
              ...
              <a
                href="/course-ex/topic1"
                className="flex items-center justify-center rounded-[8px] mt-[28px] ml-[680px] drop-shadow-[0px_4px_0px_rgba(0,0,0,0.25)] bg-[#FFCA61] w-[108px] h-[41px] text-[16px] mr-[6px]"
              >
                ถัดไป 🡺
              </a>
            </div>
