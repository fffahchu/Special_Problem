                    ...
                    <div className="flex flex-row-2">
                            ...
                            <ol className="ml-[40px] mt-[32px]">
                                ...
                                <li class="border-l-2 border-[#FFCA61]">
                                    <div class="md:flex flex-start">
                                        ...
                                        <a href="#" className="w-[200px] h-[72px] ml-[28px] text-[#FFCA61]">บทที่ 5 การเขียนโปรแกรมแบบทำซ้ำ</a>
                                    </div>
                                </li>
                        ...
                        <iframe width="800" height="450" src="https://www.youtube.com/embed/selH-JKRDk0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" className="mt-[20px] rounded-[11px]" allowfullscreen></iframe>
                            <div className="flex justify-between items-center">
                                <a href="#" className="flex items-center justify-center rounded-[8px] mt-[15px] drop-shadow-[0px_4px_0px_rgba(0,0,0,0.25)] bg-white border-[1px] border-[#AEAEAE] w-[108px] h-[41px] text-[16px]">
                                    🡸 ก่อนหน้า
                                </a>
                                <a href="/course-ex/test1" className="flex items-center justify-center rounded-[8px] mt-[15px] drop-shadow-[0px_4px_0px_rgba(0,0,0,0.25)] bg-[#FFCA61] w-[108px] h-[41px] text-[16px]">
                                    ถัดไป 🡺
                                </a>
                            </div>
                        </div>
