                    ...
                    <div className="flex flex-row-2">
                            ...
                            <ol className="ml-[40px] mt-[32px]">
                                ...
                                <li class="border-l-2 border-[#FFCA61]">
                                    <div class="md:flex flex-start">
                                        ...
                                        <a href="#" className="w-[200px] h-[96px] ml-[28px] text-[#FFCA61]">บทที่ 1 การพัฒนาโปรแกรมคอมพิวเตอร์และการเขียนผังงานซี</a>
                                    </div>
                                </li>
                        ...
                        <div className="flex flex-col mx-auto">
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <a href="/course-ex/topic2" className="flex items-center justify-center rounded-[8px] mt-[15px] drop-shadow-[0px_4px_0px_rgba(0,0,0,0.25)] bg-[#FFCA61] w-[108px] h-[41px] text-[16px]">
                                    ถัดไป 🡺
                                </a>
                            </div>
                        </div>
