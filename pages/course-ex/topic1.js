...
>>>>>>> Stashed changes
        ...
        /div> <
        a href = "#"
        className = "w-[200px] h-[96px] text-black ml-[28px] text-[color:#FFA400]" > บทที่ 1 การพั ฒนาโปรแกรมคอมพิวเตอร์ และการเขียนผั งงานซี < /a> <
        /div> <
        /li> <
...
<<<<<<< HEAD
                        ...
                        <div className="flex flex-col mx-auto">
                            <iframe width="800" height="450" src="https://www.youtube.com/embed/vcaBmzK90fs" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" className="mt-[20px] rounded-[11px]" allowfullscreen></iframe>
                            <div className="flex justify-between items-center">
                                ...
                                <a href="/course-ex/topic2" className="flex items-center justify-center rounded-[8px] mt-[15px] drop-shadow-[0px_4px_0px_rgba(0,0,0,0.25)] bg-[#FFCA61] w-[108px] h-[41px]">
