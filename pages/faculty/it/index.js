  ...
  return (
    <div className="px-[104px] py-[29px]">
      ...
      <div className="flex justify-center gap-32 my-[150px]">
        <Link href="/reviews-major/it" className="flex flex-row gap-2">
        ...
        <Link href="/reviews-activity/it" className="flex flex-row gap-2">
          <div className="relative overflow-hidden rounded-full">
            <img
        ...
        <Link href="/reviews-major/genit" className="flex flex-row gap-2">
          <div className="relative overflow-hidden rounded-full">
            <img
