...
<<<<<<< Updated upstream
    return ( <
        ...
        /> <
        div className = "font-semibold text-[30px] text-center mt-[38px] mb-[48px]" > ข่ าวสาร < /div> <
        /div> <
        ...
        div className = "px-[104px] pt-[29px]" >
        <
        div className = "font-semibold text-[20px] mt-[75px] mb-[30px]" > ข่ าวฮอต < /div> <
        ...
        /div> <
        div className = "font-semibold text-[20px] mt-[75px] mb-[30px]" > ข่ าวทั้ งหมด < /div> <
        ...
        <
        div className = "mx-[22px] mt-[24px] text-[17px] font-semibold" >
        TCAS66 รอบ Portfolio มหาวิทยาลั ยเชียงใหม่ <
        /div> <
        div className = "flex justify-between items-center mt-[55px]" >
        <
        div className = "flex flex-row items-center" >
        ...
        /div> <
        /div> <
        a href = "https://www.dek-d.com/tcas/61282/"
        target = "_blank" >
        <
        button className = "font-semibold mr-[22px] py-2 px-6 rounded-full border-[1px]" >
        อ่ านเพิ่ มเติม <
        ...
        <
        div className = "mx-[22px] mt-[24px] text-[17px] font-semibold" >
        TCAS 66 รอบ 1: ม.แม่ ฟ้ าหลวง 5 โครงการ <
        /div> <
        div className = "flex justify-between items-center mt-[55px]" >
        <
        div className = "flex flex-row items-center" >
        ...
        /div> <
        /div> <
        a href = "https://www.dek-d.com/tcas/61272/"
        target = "_blank" >
        <
        button className = "font-semibold mr-[22px] py-2 px-6 rounded-full border-[1px]" >
        อ่ านเพิ่ มเติม <
...
>>>>>>> Stashed changes
        ...
        <
        div className = "mx-[22px] mt-[24px] text-[17px] font-semibold" >
        มาแล้ ว!ปฏิทิน TCAS66 มหาวิทยาลั ยมหิดล ทั้ ง 4 รอบ เริ่ มรอบแรกตุลาคมนี้ แล้ ว <
        /div> <
        div className = "flex justify-between items-center mt-[28px]" >
        <
        div className = "flex flex-row items-center" >
        ...
        /div> <
        /div> <
        a href = "https://www.dek-d.com/tcas/61206/"
        target = "_blank" >
        <
        button className = "font-semibold mr-[22px] py-2 px-6 rounded-full border-[1px]" >
        อ่ านเพิ่ มเติม <
