...
function Article() {
    ...
    const article = [{
            ...
            content: "มีน้องหลายคนกังวลเกี่ยวกับการเตรียมตัว วันนี้พี่เลยอยากมาแชร์เกร็ดเล็ก ๆ น้อย ๆ เกี่ยวกับการสอบสัมภาษณ์หน่อย เอาจริง ๆ ผู้ให...",
            views: 39517,
        ...
        },
        {
            ...
            content: "การใช้สีในการทำ พอร์ต มีผลต่อความรู้สึก แล้วสีจะมีผลต่อคะแนนเราไหม แน่นอนว่าสีช่วยเพิ่มการดึงดูด และน่าสนใจ แต่!! สีไม่ไ...",
            views: 20629,
        ...
        },
        {
            ...
            content: "ใกล้เข้าสู่เทศกาลของการสมัคร TCAS รอบที่ 1 แล้ว ซึ่งการสมัครในรอบนี้เป็นการชิงตั๋วเข้าเรียนต่อสำหรับน้อง ๆ  ที่มีผลงานทางด้านกิ...",
            views: 8517,
        ...
        },
        {
            ...
            content: "มาเจาะเนื้อหา รอบ Portfolio 10 หน้า ควรมีอะไรบ้าง ใครยังงง ๆ กับการทำพอร์ต พี่อ๋องพี่วิวจะมาแผ่ให้ดูกันเลย ว่าควรทำอย่างไร ...",
            views: 3658,
    ...
    return ( <
        ...
        className = "mySwiper"
        style = {
            { marginLeft: 346, marginRight: 346, marginTop: 10 } } >
        <
        SwiperSlide >
        <
        a href = "https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.admissionpremium.com%2Fcontent%2F4147&psig=AOvVaw0DxtxmtFK-fLPDLQ0U975C&ust=1677860948404000&source=images&cd=vfe&ved=0CBAQjRxqFwoTCJDop6DVvf0CFQAAAAAdAAAAABAE"
        target = "_blank" >
        <
        img className = "object-fill w-auto h-[346px] rounded-[10px]"
        src = "http://www.admissionpremium.com/className/timthumb.php?a=t&zc=1&w=600&h=314&src=/uploads/contents/20181107175230qaq87W6.jpg"
        alt = "image slide 2" /
        >
        <
        /a> <
        ...
        SwiperSlide >
        <
        a href = "https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.admissionpremium.com%2Fcontent%2F4371&psig=AOvVaw2PhU8ihBDfSxzkIbcfnxz6&ust=1677860757409000&source=images&cd=vfe&ved=0CBAQjRxqFwoTCMCYgMXUvf0CFQAAAAAdAAAAABAE"
        target = "_blank" >
        <
        img className = "object-fill w-auto h-[346px] rounded-[10px]"
        src = "http://www.admissionpremium.com/className/timthumb.php?a=t&zc=1&w=600&h=314&src=/uploads/contents/201812301344422X7Y5Qv.jpg"
        alt = "image slide 1" /
        >
        <
        /a> <
        ...
        SwiperSlide >
        <
        a href = "https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.admissionpremium.com%2Fcontent%2F4200&psig=AOvVaw2w6CFwu7Oo-NIu7GRtmpUr&ust=1677860821862000&source=images&cd=vfe&ved=0CBAQjRxqFwoTCJiG5ePUvf0CFQAAAAAdAAAAABAE"
        target = "_blank" >
        <
        img className = "object-fill w-auto h-[346px] rounded-[10px]"
        src = "http://www.admissionpremium.com/className/timthumb.php?a=t&zc=1&w=600&h=314&src=/uploads/contents/20181119111418ZgaHMKe.jpg"
        alt = "image slide 3" /
        >
        <
        /a> <
        ...
        /div> <
        div className = "font-semibold text-[20px] mt-[75px] mb-[30px]" > บทความทั้ งหมด < /div> <
        div className = "grid grid-cols-3 gap-14 mx-auto max-w-[1232px]" > { /* col 1 */ } <
        ...
        div className = "flex flex-col w-[341px] h-[417px] bg-[#F2F3EE] rounded-[10px]" >
        <
        img src = "http://www.admissionpremium.com/className/timthumb.php?a=t&zc=1&w=600&h=314&src=/uploads/contents/20181228203118KYcJr27.jpg"
        className = "w-[341px] h-[213px] rounded-tl-[10px] rounded-tr-[10px]" /
        >
        <
        div className = "mx-[22px] mt-[24px] text-[17px] font-semibold" >
        สอบสั มภาษณ์ อย่ างไร เมื่ อติดรอบ Portfolio คณะวิศวกรรมศาสตร์ <
        /div> <
        div className = "flex justify-between items-center mt-[55px]" >
        <
        div className = "flex flex-row items-center" >
        ...
        /div> <
        /div> <
        a href = "https://www.admissionpremium.com/content/4370"
        target = "_blank" >
        <
        button className = "font-semibold mr-[22px] py-2 px-6 rounded-full border-[1px]" >
        อ่ านเพิ่ มเติม <
        ...
        div className = "flex flex-col w-[341px] h-[417px] bg-[#F2F3EE] rounded-[10px]" >
        <
        img src = "https://www.admissionpremium.com/className/timthumb.php?w=600&h=315&zc=1&a=t&src=https://www.admissionpremium.com/uploads/contents/20181220172827pvB0xju.jpg"
        className = "w-[341px] h-[213px] rounded-tl-[10px] rounded-tr-[10px]" /
        >
        <
        div className = "mx-[22px] mt-[24px] text-[17px] font-semibold" >
        7 List เช็ คความพร้ อมก่ อนสอบสั มภาษณ์ <
        /div> <
        div className = "flex justify-between items-center mt-[55px]" >
        <
        div className = "flex flex-row items-center" >
        ...
        /div> <
        /div> <
        a href = "https://www.admissionpremium.com/tcaskmitl/news/4343"
        target = "_blank" >
        <
        button className = "font-semibold mr-[22px] py-2 px-6 rounded-full border-[1px]" >
        อ่ านเพิ่ มเติม <
        ...
        div className = "flex flex-col w-[341px] h-[417px] bg-[#F2F3EE] rounded-[10px]" >
        <
        img src = "http://www.admissionpremium.com/className/timthumb.php?a=t&zc=1&w=600&h=314&src=/uploads/contents/20181112215033n9k29Za.jpg"
        className = "w-[341px] h-[213px] rounded-tl-[10px] rounded-tr-[10px]" /
        >
        <
        div className = "mx-[22px] mt-[24px] text-[17px] font-semibold" >
        Portfolio ที่ ดีควรมี... <
        /div> <
        div className = "flex justify-between items-center mt-[80px]" >
        <
        div className = "flex flex-row items-center" >
        ...
        /div> <
        /div> <
        a href = "https://www.admissionpremium.com/content/4170"
        target = "_blank" >
        <
        button className = "font-semibold mr-[22px] py-2 px-6 rounded-full border-[1px]" >
        อ่ านเพิ่ มเติม <
