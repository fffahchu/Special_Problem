...
function Article() {
    ...
    return (
        <>
            ...
            <div className="px-[104px] pt-[29px]">
                <div className="font-semibold text-[20px] mt-[75px] mb-[30px] mx-auto max-w-[1232px]">บทความยอดนิยม</div>
                <div className="grid grid-cols-4 gap-7 mx-auto max-w-[1232px]">
                    {article.map((item) => {
                        return <Card item={item} type="article" />;
                    })}
                </div>
                <div className="font-semibold text-[20px] mt-[75px] mb-[30px] mx-auto max-w-[1232px]">บทความทั้งหมด</div>
