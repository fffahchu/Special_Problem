...
function Camp() {
    ...
    const activity = [{
            ...
            title: "TECH FESTIVAL",
            content: "มหกรรมด้าน Computer และTechnology เรียนกับพี่แฮม Senior Software Engineer จากประเทศ Canada และ พี่เอิร์ท จบจาก ...",
            expire_date: 1,
            link: "#",
        },
        {
            ...
            content: "เหมาะสำหรับน้อง ๆ ที่อยากต่อยอดความรู้ HTML CSS JS ให้เก่งยิ่งขึ้นด้วย JS TIER 2 และ ยังมีคอร์สสำหรับน้อง ๆ ที่ต้องการเ...",
            expire_date: 2,
            link: "#",
        },
        {
            ...
            content: "CREATIVE AI CAMP 2022 ปีนี้เรามาใน ธีม Anytime, Anywhere with AI 🤖 ในรูป แบบ Phenomena Work-based Learni...",
            expire_date: 3,
            link: "#",
        },
        {
            ...
            content: "กลับมาอีกครั้งกับค่าย Super com sci ที่ทำ ให้น้อง ๆ ได้เรียนผ่านการลงมือปฎิบัติ On-site วางแผนระบบ สร้าง App แนะแนวกา...",
            expire_date: 4,
            link: "#",
        },
    ];
    ...
    return ( <
        ...
        /> <
        div className = "font-semibold text-[30px] text-center mt-[38px] mb-[48px]" > กิจกรรม / ค่ าย < /div> < /
        div > <
        ...
        SwiperSlide >
        <
        a href = "https://www.dek-d.com/tcas/61701/"
        target = "_blank" >
        <
        ...
        SwiperSlide >
        <
        a href = "https://www.dek-d.com/tcas/61028/"
        target = "_blank" >
        <
        img className = "object-fill w-auto h-[346px] rounded-[10px]"
        ...
        SwiperSlide >
        <
        a href = "https://www.dek-d.com/tcas/60936/"
        target = "_blank" >
        <
        img className = "object-fill w-auto h-[346px] rounded-[10px]"
        ...
        div className = "px-[104px] pt-[29px]" >
        <
        div className = "font-semibold text-[20px] mt-[75px] mb-[30px]" > ค่ าย / กิจกรรมที่ จะเปิดรั บสมั ครเร็ ว ๆ นี้ < /div> <
        ...
        /div> < /
        div > <
        div className = "font-semibold text-[20px] mt-[75px] mb-[30px]" > ค่ าย / กิจกรรมทั้ งหมด < /div> <
        ...
        div className = "flex flex-col w-[341px] h-[417px] bg-[#F2F3EE] rounded-[10px]" >
        <
        img src = "https://www.camphub.in.th/wp-content/uploads/2023/02/TFUBanner.jpg.webp"
        className = "w-[341px] h-[213px] rounded-tl-[10px] rounded-tr-[10px]" /
        >
        <
        div className = "mx-[22px] mt-[24px] text-[17px] font-semibold" >
        Technology Test htmlFor University <
        /div> <
        div className = "flex justify-between items-center mt-[80px]" >
        <
        div className = "flex flex-row items-center" >
        ...
        /div> < /
        div > <
        a href = "https://www.camphub.in.th/hamster-hub-tfu/"
        target = "_blank" >
        <
        button className = "font-semibold mr-[22px] py-2 px-6 rounded-full border-[1px]" >
        อ่ านเพิ่ มเติม <
        ...
        div className = "flex flex-col w-[341px] h-[417px] bg-[#F2F3EE] rounded-[10px]" >
        <
        img src = "https://www.camphub.in.th/wp-content/uploads/2023/02/poster-16.jpg.webp"
        className = "w-[341px] h-[213px] rounded-tl-[10px] rounded-tr-[10px]" /
        >
        <
        div className = "mx-[22px] mt-[24px] text-[17px] font-semibold" > “CS Camp 15” ค่ ายวิทยาการคอมพิวเตอร์ พระจอมเกล้ าลาดกระบั ง <
        /div> <
        div className = "flex justify-between items-center mt-[55px]" >
        <
        div className = "flex flex-row items-center" >
        ...
        /div> < /
        div > <
        a href = "https://www.camphub.in.th/cs-camp-15/"
        target = "_blank" >
        <
        button className = "font-semibold mr-[22px] py-2 px-6 rounded-full border-[1px]" >
        อ่ านเพิ่ มเติม <
        ...
        div className = "flex flex-col w-[341px] h-[417px] bg-[#F2F3EE] rounded-[10px]" >
        <
        img src = "https://www.camphub.in.th/wp-content/uploads/2023/02/%E0%B8%9B%E0%B8%81%E0%B9%81%E0%B8%99%E0%B8%A7%E0%B8%99%E0%B8%AD%E0%B8%99-1-1.png"
        className = "w-[341px] h-[213px] rounded-tl-[10px] rounded-tr-[10px]" /
        >
        <
        div className = "mx-[22px] mt-[24px] text-[17px] font-semibold" >
        ...
        /div> < /
        div > <
        a href = "https://www.camphub.in.th/zero-to-hero-javascript-feb2023/"
        target = "_blank" >
        <
        button className = "font-semibold mr-[22px] py-2 px-6 rounded-full border-[1px]" >
        อ่ านเพิ่ มเติม <
