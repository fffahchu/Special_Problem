    ...
    return (
      <>
        <div className="px-[104px] pt-[29px]">
          ...
          <div className="font-semibold text-[30px] text-center mt-[38px] mb-[48px]">
            กิจกรรม/ค่าย
          </div>
        </div>
        <Swiper
        ...
        <div className="px-[104px] pt-[29px]">
          <div className="font-semibold text-[20px] mt-[75px] mb-[30px] mx-auto max-w-[1232px]">
          ...
          <div className="grid grid-cols-3 gap-14 mx-auto max-w-[1232px]">
            ...
            <div className="flex flex-col w-[341px] h-[417px] bg-[#F2F3EE] rounded-[10px]">
              ...
              <div className="flex justify-between items-center mt-[80px]">
                ...
                <a
                  href="https://www.camphub.in.th/hamster-hub-tfu/"
                  target="_blank"
                >
                  <button className="font-semibold mr-[22px] py-2 px-6 rounded-full border-[1px]">
                    อ่านเพิ่มเติม
            ...
            <div className="flex flex-col w-[341px] h-[417px] bg-[#F2F3EE] rounded-[10px]">
              ...
              <div className="flex justify-between items-center mt-[80px]">
                ...
                <a
                  href="https://www.camphub.in.th/zero-to-hero-javascript-feb2023/"
                  target="_blank"
                >
                  <button className="font-semibold mr-[22px] py-2 px-6 rounded-full border-[1px]">
                    อ่านเพิ่มเติม
