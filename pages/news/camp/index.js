...
function Camp() {
    ...
    return (
        <>
            ...
            <div className="px-[104px] pt-[29px]">
                <div className="font-semibold text-[20px] mt-[75px] mb-[30px] mx-auto max-w-[1232px]">ค่าย/กิจกรรมที่จะเปิดรับสมัครเร็ว ๆ นี้</div>
                ...
                <div className="font-semibold text-[20px] mt-[75px] mb-[30px] mx-auto max-w-[1232px]">ค่าย/กิจกรรมทั้งหมด</div>
