      ...
      <div className="grid grid-cols-2">
        <div className="flex-col pl-[104px]">
          ...
          <p className="w-[480px] font-semibold pt-[26px] text-[20px]">
            ComPort ตั วช่ วยดี ๆ สำหรั บน้ อง ๆ หนู ๆ ในเรื่ องการทำ Portfolio
            สายคอมฯ ให้ เสร็ จอย่ างรวดเร็ วและสวยงาม!🔥👍
          </p>{" "}
          <p className="w-[480px] font-semibold pt-[26px] text-[16px]">
            เหมาะสำหรั บนั กเรียนที่ มีความสนใจจะศึกษาต่ อในระดั บปริญญาตรี
            ในสาขาวิชาทางด้ านคอมพิวเตอร์ เป็ นแหล่ งรวบรวมข้ อมูลข่
            าวสารและความรู้ ด้ านสายการเรียนสายคอมพิวเตอร์ นอกจากนี้ ยั งมีคอร์
            สเรียนฟรีมากมาย อั ดแน่ นไปด้ วยเนื้ อหาสาระที่ เป็ นประโยชน์ สำหรั
            บผู้ ใช้ บริการเว็ บไซต์ เมื่ อเรียนจบมีใบรั บรองด้ วย ครบ...จบในที่
            เดียว✨ ที่ นี่ เลย{" "}
          </p>{" "}
          <a
            href="#_"
