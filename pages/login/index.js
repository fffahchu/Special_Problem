    ...
    return (
      <div className="px-[104px] py-[29px]">
        ...
        <div className="flex-center shadow-inner shadow-[#bbf7d0] w-[354px] h-[573px] border-[1px] border-[#bbf7d0] rounded ml-[475px]">
          <div className=" font-bold pl-[25px] mt-[30px]">
            ชื่อผู้ใช้งาน หรือ อีเมล
          </div>

          <input
            className="w-[306px] h-[35px] ml-[23px] mt-[8px] border-[1px] border-[#bbf7d0] rounded-lg shadow-md shadow-[#dcfce7]"
            type="email"
          ></input>
          <div className=" font-bold pl-[25px] mt-[20px]">รหัสผ่าน</div>
          <input
            className="w-[306px] h-[35px] ml-[23px] mt-[8px] border-[1px] border-[#bbf7d0] rounded-lg shadow-md shadow-[#dcfce7]"
            type="text"
          ></input>
          <div className="flex justify-between items-center mt-[20px] ml-[23px]">
