...
const Footer = () => {
  return (
    <div className="grid grid-cols-6 bg-green px-[104px] pt-[55px] pb-[60px]">
      ...
      <div className="flex flex-col gap-4 font-semibold ml-[60px]">
        <div>หน้าหลัก</div>
      ...
      <div className="flex flex-col gap-4 font-semibold ml-[67px]">
      ...
      <div className="flex flex-col gap-4 font-semibold ml-[87px]">
      ...
      <div className="ml-[89px]">
        ...
        <div className="flex flex-col gap-4 mt-[32px]">
          ...
          <div className="flex gap-2">
            <img src="assets/icons/line.svg" alt="line" width="18" height="18" />
            <div>Line</div>
          </div>
          <div className="flex gap-2">
            <img src="assets/icons/facebook.svg" alt="line" width="18" height="18" />
            <div>Facebook</div>
          </div>
          <div className="flex gap-2">
            <img src="assets/icons/instagram.svg" alt="line" width="18" height="18" />
            <div>Instagram</div>
          </div>
          <div className="flex gap-2">
            <img src="assets/icons/youtube.svg" alt="line" width="18" height="18" />
            <div>Youtube</div>
          </div>
          <div className="flex gap-2">
            <img src="assets/icons/twitter.svg" alt="line" width="18" height="18" />
            <div>Twitter</div>
          </div>
        </div>
      </div>
